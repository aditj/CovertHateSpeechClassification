...
class Server():
    ...
    def train(self):
        ...
        with open(self.cumm_exp_res_file,"a") as f:
            f.write(datetime.datetime.now().strftime('%Y-%m-%d_%H:%M:%S')+": "+ self.experiment_condition + "acc: " + str(accuracy) + ", " + str(evaluations_smart) + ", " + str(self.aggregated_loss)+ ", " + str(self.count_learning_queries))
            f.write('\n')
